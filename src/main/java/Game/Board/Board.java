...
public class Board extends JFrame
{
    ...
    public void pownToHome(int idx)
    {
        ...
        {
            if(field[72].getPown()==null) {field[72].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[73].getPown()==null) {field[73].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[74].getPown()==null) {field[74].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[75].getPown()==null) {field[75].setPown(tmp.getPown());tmp.setPown(null); return; }
        }
        if(tmp.getPown().getColor()==PlayerColor.GREEN)
        {
            if(field[76].getPown()==null) {field[76].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[77].getPown()==null) {field[77].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[78].getPown()==null) {field[78].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[79].getPown()==null) {field[79].setPown(tmp.getPown());tmp.setPown(null); return; }
        }
        if(tmp.getPown().getColor()==PlayerColor.YELLOW)
        {
            if(field[80].getPown()==null) {field[80].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[81].getPown()==null) {field[81].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[82].getPown()==null) {field[82].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[83].getPown()==null) {field[83].setPown(tmp.getPown());tmp.setPown(null); return; }
        }
        if(tmp.getPown().getColor()==PlayerColor.BLUE)
        {
            if(field[84].getPown()==null) {field[84].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[85].getPown()==null) {field[85].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[86].getPown()==null) {field[86].setPown(tmp.getPown());tmp.setPown(null); return; }
            if(field[87].getPown()==null) {field[87].setPown(tmp.getPown());tmp.setPown(null); return; }
        }
    }
    ...
    public void movePown(int idx, int rollNumber) // wykonujemy
    {
        Field tmp=field[idx];
    ...
    public int checkLegalMove(int idx) //sprawdzamy
    {
        int num=rollNumberint;
        int x=idx+num;
    ...
    public int checkMove(int idx)
    {
        ...
        {
            if(rollNumberint==1||rollNumberint==6)// sprawdzenie czy promocja piona
            {
    ...
    public void actionListener(ActionEvent e)
    {
        ...
        if(isMyTurn()) {
            ...
            {
                if(z == roll1) {
                    int x =1; setRollNumber("" + x); rollNumberint = x;
                    if(!checkPosibleMove()) {
                        nextTurn();
                    }
                }
                if(z == roll2) {
                    int x = 2; setRollNumber("" + x); rollNumberint = x;
                    if(!checkPosibleMove()) {
                        nextTurn();
                    }
                }
                if(z == roll3) {
                    int x =3; setRollNumber("" + x); rollNumberint = x;
                    if(!checkPosibleMove()) {
                        nextTurn();
                    }
                }
                if(z == roll4) {
                    int x =4; setRollNumber("" + x); rollNumberint = x;
                    if(!checkPosibleMove()) {
                        nextTurn();
                    }
                }
                if(z == roll5) {
                    int x =5; setRollNumber("" + x); rollNumberint = x;
                    if(!checkPosibleMove()) {
                        nextTurn();
                    }
                }
                if(z == roll6) {
                    int x =6; setRollNumber("" + x); rollNumberint = x;
                    if(!checkPosibleMove()) {
                        nextTurn();
                    }
                }
    ...
    public void createFields()
    {
        ...
        for(int i=0;i<72;i++) {
            ...
            if(5<=i&&i<10)field[i] = new Field(sx - (i-4) * 47, sy - 5 * 47, x, i, panel,this::buttonListener);
            if(10<=i&&i<13)field[i] = new Field(sx - 6*47, sy - (i- 5) * 47, x, i, panel,this::buttonListener);
            if(13<=i&&i<18)field[i] = new Field(sx - (18-i)*47, sy - 7 * 47, x, i, panel,this::buttonListener);
            if(18<=i&&i<23)field[i] = new Field(sx , sy - (i-10) * 47, x, i, panel,this::buttonListener);
            if(23<=i&&i<26)field[i] = new Field(sx +(i-23)*47 , sy - 13 * 47, x, i, panel,this::buttonListener);
            if(26<=i&&i<31)field[i] = new Field(sx +2*47, sy + (i-38) * 47, x, i, panel,this::buttonListener);
            if(31<=i&&i<36)field[i] = new Field(sx +(i-28)*47, sy - 7* 47, x, i, panel,this::buttonListener);
            if(36<=i&&i<39)field[i] = new Field(sx + 8*47, sy +(i-43)*47, x, i, panel,this::buttonListener);
            if(39<=i&&i<44)field[i] = new Field(sx +(46-i)*47, sy - 5* 47, x, i, panel,this::buttonListener);
            if(44<=i&&i<49)field[i] = new Field(sx +2*47, sy -(48-i)*47, x, i, panel,this::buttonListener);
            if(49<=i&&i<52)field[i] = new Field(sx + (51-i)*47, sy+47, x, i, panel,this::buttonListener);
            if(52<=i&&i<57)field[i] = new Field(sx + 47, sy +(52-i)*47, x, i, panel,this::buttonListener); //red <52-56>
            if(57<=i&&i<62)field[i] = new Field(sx - (62-i)*47, sy - 6 * 47, x, i, panel,this::buttonListener); //green <57-61>
            if(62<=i&&i<67)field[i] = new Field(sx + 47, sy + (i-74) * 47, x, i, panel,this::buttonListener); //yellow <62-66>
            if(67<=i&&i<72)field[i] = new Field(sx +(74-i)*47, sy - 6* 47, x, i, panel,this::buttonListener); //blue <67-71>
        }
        //radeBase
        field[72] = new Field(79,504, y, 72, panel,this::buttonListener,new Pown(79,504,PlayerColor.RED,panel));
        field[73] = new Field(157,504, y, 73, panel,this::buttonListener,new Pown(157,504,PlayerColor.RED,panel));
        field[74] = new Field(79,583, y, 74, panel,this::buttonListener,new Pown(79,583,PlayerColor.RED,panel));
        field[75] = new Field(157,583, y, 75, panel,this::buttonListener,new Pown(157,583,PlayerColor.RED,panel));
        //greenBase
        field[76] = new Field(79,79, y, 76, panel,this::buttonListener,new Pown(79,79,PlayerColor.GREEN,panel));
        field[77] = new Field(157,79, y, 77, panel,this::buttonListener,new Pown(157,79,PlayerColor.GREEN,panel));
        field[78] = new Field(79,157, y, 78, panel,this::buttonListener,new Pown(79,157,PlayerColor.GREEN,panel));
        field[79] = new Field(157,157, y, 79, panel,this::buttonListener,new Pown(157,157,PlayerColor.GREEN,panel));
        //yellowBase
        field[80] = new Field(504,79, y, 80, panel,this::buttonListener,new Pown(504,79,PlayerColor.YELLOW,panel));
        field[81] = new Field(583,79, y, 81, panel,this::buttonListener,new Pown(583,79,PlayerColor.YELLOW,panel));
        field[82] = new Field(504,157, y, 82, panel,this::buttonListener,new Pown(504,157,PlayerColor.YELLOW,panel));
        field[83] = new Field(583,157, y, 83, panel,this::buttonListener,new Pown(583,157,PlayerColor.YELLOW,panel));
        //blueBase
        field[84] = new Field(504,504, y, 84, panel,this::buttonListener,new Pown(504,504,PlayerColor.BLUE,panel));
        field[85] = new Field(583,504, y, 85, panel,this::buttonListener,new Pown(583,504,PlayerColor.BLUE,panel));
        field[86] = new Field(504,583, y, 86, panel,this::buttonListener,new Pown(504,583,PlayerColor.BLUE,panel));
        field[87] = new Field(583,583, y, 87, panel,this::buttonListener,new Pown(583,583,PlayerColor.BLUE,panel));
    }
