...
public class Game extends JFrame
{
    ...
    private Player greenPlayer;     // 2
    private Player yellowPlayer;    // 3
    private Player bluePlayer;      // 4
...
//                            send("TABLEINGAME;"+tableNumber);
    ...
    {
        if(idx.equals("0")) if(redPlayer==null)  { addPlayer(nickName,PlayerColor.RED); setPlayerColor(PlayerColor.RED);};
        if(idx.equals("1")) if(greenPlayer==null) {addPlayer(nickName,PlayerColor.GREEN);setPlayerColor(PlayerColor.GREEN);}
        if(idx.equals("2")) if(yellowPlayer==null){addPlayer(nickName,PlayerColor.YELLOW);setPlayerColor(PlayerColor.YELLOW);}
        if(idx.equals("3")) if(bluePlayer==null)  {addPlayer(nickName,PlayerColor.BLUE);setPlayerColor(PlayerColor.BLUE);}
    }
